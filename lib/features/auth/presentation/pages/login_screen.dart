...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: BlocConsumer<LoginCubit, LoginState>( // Tetap menggunakan BlocConsumer
                          ...
                          Center(
                            child: Column(
                              children: [
                                ...
                                Image.asset(ImageResources.appIconPng, height: 45),
                                const SizedBox(height: 2),
                                const Text("U-pro", style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.w600)),
                              ],
                            ),
                          ),
                          const SizedBox(height: 20),
                          const Text('Login', style: AppTextStyles.headline1, textAlign: TextAlign.center),
                          const SizedBox(height: 8),
                          const Text('Silahkan masukkan NIK dan password Anda', style: AppTextStyles.body2, textAlign: TextAlign.center),
                          const SizedBox(height: 24),
                          // NIK Input
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              const Text('NIK Karyawan', style: AppTextStyles.body2),
                              const SizedBox(height: 8),
                              TextFormField(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Image.asset(ImageResources.kallaToyotaLogopng, width: 150, height: 50),
                      ],
                    ),
                  ),
                ),
